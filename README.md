...
**IoT Engineering @ BUPT** · Intern @ **PolyU ASTAPLE Lab**
...
2024-cohort student in **Internet of Things Engineering** at Beijing University of Posts and Telecommunications (BUPT).  
...
`Python` · `PyTorch` · `Android / GUI Agents` · `LLM Agents` · `Docker`
